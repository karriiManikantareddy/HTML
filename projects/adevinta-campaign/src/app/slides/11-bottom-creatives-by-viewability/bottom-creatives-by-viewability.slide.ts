...
@Component({
  selector: 'bottom-creatives-by-viewability',
  templateUrl: './bottom-creatives-by-viewability.slide.html',
  styleUrls: ['./bottom-creatives-by-viewability.slide.less']
})
export class BottomCreativesByViewabilitySlide {
  loading = true
  ...
  constructor(
    ...
    .subscribe(([creatives, chartColor]) => {
      ...
      this.bottomCreatives = creatives
        .sortBy('metrics.gam_viewability.value', false)
