...
@Component({
  selector: 'audience-extension-video-gcm-youtube',
  templateUrl: './audience-extension-video-gcm-youtube.slide.html',
  styleUrls: ['./audience-extension-video-gcm-youtube.slide.less']
})
export class AudienceExtensionVideoGcmYoutubeSlide {
  loading = true
  hasAEV = false
  creatives = []
  maxNameLength = 18
