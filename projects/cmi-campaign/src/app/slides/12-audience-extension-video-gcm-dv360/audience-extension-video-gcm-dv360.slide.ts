...
@Component({
  selector: 'audience-extension-video-gcm-dv360',
  templateUrl: './audience-extension-video-gcm-dv360.slide.html',
  styleUrls: ['./audience-extension-video-gcm-dv360.slide.less']
})
export class AudienceExtensionVideoGcmDv360Slide {
  loading = true
  hasAEV = false
  creatives = []
  maxNameLength = 18
