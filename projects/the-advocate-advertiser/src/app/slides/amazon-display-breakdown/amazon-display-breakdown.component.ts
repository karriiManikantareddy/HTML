...
@Component({
  selector: 'amazon-display-breakdown',
  templateUrl: './amazon-display-breakdown.component.html',
})
export class AmazonDisplayBreakdownComponent {
  ...
  constructor(dataService: TheAdvocateDataService) {
    combineLatest([
      ...
      dataService.amazonDisplayBreakdownItems(),
