...
@Component({
  selector: 'audience-extension-display-simplifi',
  templateUrl: './audience-extension-display-simpli.fi.slide.html',
  styleUrls: ['./audience-extension-display-simpli.fi.slide.less']
})
export class AudienceExtensionDisplaySimpliFiSlide {
  loading = true
  hasAed = false
  creatives = []
  maxNameLength = 18
