...
@Component({
  selector: 'bottom-creatives-by-ctr',
  templateUrl: './bottom-creatives-by-ctr.slide.html',
  styleUrls: ['./bottom-creatives-by-ctr.slide.less']
})
export class BottomCreativesByCTRSlide {
  loading = true
  ...
  constructor(
    ...
    .subscribe(([creatives, chartColor]) => {
      ...
      this.bottomCreatives = creatives
        .sortBy('metrics.ctr.value', false)
