...
@Component({
  selector: 'top-creatives-by-ctr',
  templateUrl: './top-creatives-by-ctr.slide.html',
  styleUrls: ['./top-creatives-by-ctr.slide.less']
})
export class TopCreativesByCTRSlide {
  loading = true
