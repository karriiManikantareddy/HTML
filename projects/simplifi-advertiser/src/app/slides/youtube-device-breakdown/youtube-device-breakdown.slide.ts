...
@Component({
  selector: 'youtube-device-breakdown',
  templateUrl: './youtube-device-breakdown.slide.html',
  styleUrls: ['./youtube-device-breakdown.slide.less']
})
export class YoutubeDeviceBreakdownSlide {
  loading = true
  series: any[]
  ...
  constructor(
    ...
    dataService.youtubeDevices().subscribe(devices => {
      this.loading = false
