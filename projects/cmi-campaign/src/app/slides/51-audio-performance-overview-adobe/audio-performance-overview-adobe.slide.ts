...
@Component({
  selector: 'audio-performance-overview-adobe',
  templateUrl: './audio-performance-overview-adobe.slide.html',
  styleUrls: ['./audio-performance-overview-adobe.slide.less']
})
export class AudioPerformanceOverviewAdobeSlide {
  loading = false
  creatives = []
  maxNameLength = 18
  metrics = [
    ...
    {metric: 'viewed_minutes', name_1: 'Minutes Listened', format: 'number', description: 'Total minutes that users engaged with your audio message'},
  ]
  footerMetrics = [
