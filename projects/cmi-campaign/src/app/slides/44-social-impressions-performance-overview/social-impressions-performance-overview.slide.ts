...
@Component({
  selector: 'social-impressions-performance-overview',
  templateUrl: './social-impressions-performance-overview.slide.html',
  styleUrls: ['./social-impressions-performance-overview.slide.less']
})
export class SocialImpressionsPerformanceOverviewSlide {
  loading = true
  hasSocial = false
  creatives = []
  maxNameLength = 18
  metrics = [
    ...
    {metric: '_clicks', name_1: 'Total Actions', format: 'number', description: 'No. of clicks to your social media  page/website'},
