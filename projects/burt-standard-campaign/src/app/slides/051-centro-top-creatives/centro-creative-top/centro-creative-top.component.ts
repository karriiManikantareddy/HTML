...
@Component({
  selector: 'centro-creative-top',
  templateUrl: './centro-creative-top.component.html',
  styleUrls: ['./centro-creative-top.component.less']
})
export class CentroCreativeTopComponent implements OnInit {
  ...
  ngOnInit() {
    const shareOfImpressions = this.shareOfTotals['imps_won'] = <number>Object.get(this.creative, 'metrics.imps_won.value') / this.totalMetrics['imps_won']
