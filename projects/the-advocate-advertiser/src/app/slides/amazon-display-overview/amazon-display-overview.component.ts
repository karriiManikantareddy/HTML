...
@Component({
  selector: 'amazon-display',
  templateUrl: './amazon-display-overview.component.html',
})
export class AmazonDisplayOverviewComponent {
  ...
  constructor(
    ...
    combineLatest([
      ...
      dataService.amazonDisplayTotalsByDay(),
