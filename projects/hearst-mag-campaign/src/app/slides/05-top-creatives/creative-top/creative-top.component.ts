...
export class CreativeTopComponent implements OnInit {
  ...
  ngOnInit() {
    const shareOfImpressions = this.shareOfTotals['third_party_impressions'] = <number>Object.get(this.creative, 'metrics.third_party_impressions.value') / this.totalMetrics['third_party_impressions']
    const shareOfClicks = this.shareOfTotals['third_party_clicks'] = <number>Object.get(this.creative, 'metrics.third_party_clicks.value') / this.totalMetrics['third_party_clicks']
