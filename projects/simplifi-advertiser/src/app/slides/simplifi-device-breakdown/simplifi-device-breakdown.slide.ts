...
@Component({
  selector: 'simplifi-device-breakdown',
  templateUrl: './simplifi-device-breakdown.slide.html',
  styleUrls: ['./simplifi-device-breakdown.slide.less']
})
export class SimplifiDeviceBreakdownSlide {
  loading = true
  series: any[]
  legendItems: any[] = []
  ...
  constructor(
    ...
    dataService.simplifiDeviceBreakdownItems().subscribe(devices => {
      this.loading = false
