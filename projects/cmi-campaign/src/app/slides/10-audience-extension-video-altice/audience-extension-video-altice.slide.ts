...
@Component({
  selector: 'audience-extension-video-altice',
  templateUrl: './audience-extension-video-altice.slide.html',
  styleUrls: ['./audience-extension-video-altice.slide.less']
})
export class AudienceExtensionVideoAlticeSlide {
  loading = true
  hasAEV = false
  creatives = []
  maxNameLength = 18
