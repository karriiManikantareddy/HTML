...
@Component({
  selector: 'audience-extension-display-gcm-dv360',
  templateUrl: './audience-extension-display-gcm-dv360.slide.html',
  styleUrls: ['./audience-extension-display-gcm-dv360.slide.less']
})
export class AudienceExtensionDisplayGcmDv360Slide {
  loading = true
  hasAed = false
  creatives = []
  maxNameLength = 18
