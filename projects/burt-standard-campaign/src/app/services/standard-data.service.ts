...
export abstract class StandardDataService {
  ...
  abstract centroTotals(): Observable<any>
  abstract series(): Observable<any>
  abstract centroSeries(): Observable<any>
  abstract lineItems(): Observable<any>
  abstract centroLineItems(): Observable<any>
  abstract creatives(): Observable<any>
  abstract centroCreatives(): Observable<any>
  abstract creativeSizes(): Observable<any>
  abstract platforms(): Observable<any>
  abstract centroPlatforms(): Observable<any>
  abstract regions(): Observable<any>
  abstract centroRegions(): Observable<any>
