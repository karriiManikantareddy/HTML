...
@Component({
  selector: 'amazon-video-breakdown',
  templateUrl: './amazon-video-breakdown.component.html',
})
export class AmazonVideoBreakdownComponent {
  ...
  constructor(dataService: TheAdvocateDataService) {
    combineLatest([
      ...
      dataService.amazonVideoBreakdownItems(),
