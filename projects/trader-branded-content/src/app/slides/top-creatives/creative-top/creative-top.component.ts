...
import { DfpCreative } from '../../../services/standard-data.service'
...
export class CreativeTopComponent implements OnInit {
  ...
  constructor(el: ElementRef, variables: TraderVariables) {
    this.el = el
    const colors = variables.colors
    this.impressionsGaugeOptions = Object.add(this.gaugeOptions, {colors: [colors.red, colors.light_gray]})
    this.clicksGaugeOptions = Object.add(this.gaugeOptions, {colors: [colors.light_blue, colors.light_gray]})
  }
