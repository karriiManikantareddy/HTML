...
@Component({
  selector: 'google-performance-max-overview',
  templateUrl: './google-performance-max-overview.slide.html',
})
export class GooglePerformanceMaxOverviewSlide {
  loading = true
  ...
  constructor(
    ...
    forkJoin([
      ...
      dataService.googlePerformanceMaxTotalsByDay(),
