...
@Component({
  selector: 'audience-extension-display-gcm-amazon-conversion',
  templateUrl: './audience-extension-display-gcm-amazon-conversion.slide.html',
  styleUrls: ['./audience-extension-display-gcm-amazon-conversion.slide.less']
})
export class AudienceExtensionDisplayGcmAmazonConversionSlide {
  loading = true
  hasAed = false
  creatives = []
  maxNameLength = 18
