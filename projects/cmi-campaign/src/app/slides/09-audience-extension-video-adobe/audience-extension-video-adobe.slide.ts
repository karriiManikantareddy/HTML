...
@Component({
  selector: 'audience-extension-video-adobe',
  templateUrl: './audience-extension-video-adobe.slide.html',
  styleUrls: ['./audience-extension-video-adobe.slide.less']
})
export class AudienceExtensionVideoAdobeSlide {
  loading = true
  hasAEV = false
  creatives = []
  maxNameLength = 18
